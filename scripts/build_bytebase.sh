...
flags="-X 'github.com/ashutoshojha5/bytebase/backend/bin/server/cmd.version=${VERSION}'
-X 'github.com/ashutoshojha5/bytebase/backend/bin/server/cmd.goversion=$(go version)'
-X 'github.com/ashutoshojha5/bytebase/backend/bin/server/cmd.gitcommit=$(git rev-parse HEAD)'
-X 'github.com/ashutoshojha5/bytebase/backend/bin/server/cmd.buildtime=$(date -u +"%Y-%m-%dT%H:%M:%SZ")'
-X 'github.com/ashutoshojha5/bytebase/backend/bin/server/cmd.builduser=$(id -u -n)'"
